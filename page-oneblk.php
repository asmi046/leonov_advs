	...
	<div class = "line contentAllLine contentAllPage">
		<div class = "centerLine">
			...
			<div class = "content reklamaBlk">
					...
					<?php
								...
								foreach ($result as $row) {
									...
									$tableStr .= "<tr id = '".$row->id."'>";
										$tableStr .= "<td  style = 'border-left: 1px solid lightgray;' id = 'cl0' class = 'tdBascetT cl0'><i onclick = 'addPlex(".$row->id.");'; title = 'Добавить в корзину' class='toCartBtn  CartBtn CartBtn".$row->id." fa fa-shopping-cart' aria-hidden='true'></i></td>";
				...
				<div style = "border:none;" class = "tableBlk">
					<?php echo $tableStr;?>	
				</div>
