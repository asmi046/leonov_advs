$(function() {      
  var slider = $('.slider'),
	...
	slideCount = $('.slider .wrImg').length,               // Количество слайдов
  ...
  clickBullets=0,
	...
	$('.slider .wrImg').css("width", slideWidth+"px")
	$('.slider img').css("width", slideWidth+"px")
  ...
  $('.slider .wrImg:last').clone().prependTo('.slider');   // Копия последнего слайда помещается в начало.
  $('.slider .wrImg').eq(1).clone().appendTo('.slider');   // Копия первого слайда помещается в конец.  
